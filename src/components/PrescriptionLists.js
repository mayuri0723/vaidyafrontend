...
const PrescriptionLists = () => {
  ...
  console.log("Prescriptions are", patientPrescriptionData)
...
const generatePrecription = (prescription) => {
    // Retrieve the prescription object for the specified index
    // const prescription = userPrescriptions[index];
