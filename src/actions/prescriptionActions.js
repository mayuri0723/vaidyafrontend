...
export const getMedicines = () => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.get('http://192.168.1.4/api/prescription/get_medicines')
...
export const addPrescriptionUser = (prescriptionData) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post(`http://192.168.1.4/api/prescription/add_prescription`, prescriptionData)
...
export const addDietChart = (diet) => async (dispatch, getState) => {
    try {
        ...
        // Make request to server and get the response data
        const { data } = await axios.post(`http://192.168.1.4/api/prescription/add_dietchart`, diet)
...
export const getPrescription = () => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.get('http://192.168.1.4/api/prescription/get_prescription')
...
export const getDietChartList = () => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.get('http://192.168.1.4/api/prescription/get_dietchart')
...
export const getPrescriptionDetail = () => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.get('http://192.168.1.4/api/prescription/getallPrescription')
...
export const getPatientDetail = () => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.get('http://192.168.1.4/api/prescription/getpatientPrescription')
