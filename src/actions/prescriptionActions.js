...
export const getMedicines = () => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.get('https://vaidyabackend.vercel.app/api/prescription/get_medicines')
...
export const addPrescriptionUser = (prescriptionData) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post(`https://vaidyabackend.vercel.app/api/prescription/add_prescription`, prescriptionData)
...
export const addDietChart = (diet) => async (dispatch, getState) => {
    try {
        ...
        // Make request to server and get the response data
        const { data } = await axios.post(`https://vaidyabackend.vercel.app/api/prescription/add_dietchart`, diet)
...
export const getPrescription = () => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.get('https://vaidyabackend.vercel.app/api/prescription/get_prescription')
...
export const getDietChartList = () => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.get('https://vaidyabackend.vercel.app/api/prescription/get_dietchart')
...
export const getPrescriptionDetail = () => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.get('https://vaidyabackend.vercel.app/api/prescription/getallPrescription')
...
export const getPatientDetail = () => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.get('https://vaidyabackend.vercel.app/api/prescription/getpatientPrescription')
